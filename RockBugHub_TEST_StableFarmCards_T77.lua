-- RockBugHub TEST T77: stable FARM card captions; boss secondary action opens settings.
local env=_G
...
local function update()
 ...
 if boss then
  ...
  desired(boss.more and boss.more.text,isRu and"Настройки босса  →"or"Boss settings  →")
