...
local function calibrateTreadmills()
	...
	if not pet then
		status.Text="Для CAL нужен выбранный пет / _G.SelectedPet."
		running=false
		return
	end
