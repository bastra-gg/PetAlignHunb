-- PetAlignHub v44_PROGRAM_UI_ALL_CARDS
...
local function makeRockReport()
	...
	local lines={}
	table.insert(lines,"PetAlign v44 rock scan")
...
frame.Position=UDim2.new(.5,-240,.5,-280)
...
title.Text="Pet Align Program v44"
...
if okMath then
	statusText("v44: интерфейс как в проге + все карточки.")
else
