...
-- T79: background autoboss must not call the core's global STOP.
...
-- T79: do NOT load the old machine-rebirth guard.
...
-- T79 profile persistence extension. The pinned core profile writer predates
