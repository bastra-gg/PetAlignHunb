...
local l="RockBugHub_TEST_v4_27_HOLO_T34"local m="4.27HOLO-T34"local n=type(getgenv)=="function"and getgenv()or _G;
do
...
function q.openClassicPanel(tab)
if q.closePicker then q.closePicker()end;
q.uiRoot.Enabled=true;t7(false);sR(tab or "bug")
end;
local t8=nil;
