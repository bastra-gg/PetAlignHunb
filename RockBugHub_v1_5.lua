...
-- T77: background autoboss must not call the core's global STOP.
...
-- T77: do NOT load the old machine-rebirth guard.
...
-- T77 profile persistence extension. The pinned core profile writer predates
...
pcall(function()
    ...
    if runtime.layoutUI.testPersistenceVersion=="T77"then return end
    ...
    runtime.layoutUI.testPersistenceVersion="T77"
end)
