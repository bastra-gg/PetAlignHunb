-- PetAlignHub v46_NO_WINDOW_ALIGN
...
local function makeRockReport()
	...
	local lines={}
	table.insert(lines,"PetAlign v46 rock scan")
...
function updateAdaptive()
	...
	-- Только масштаб под экран. Позицию НЕ трогаем, чтобы кнопки не "выравнивали" окно.
...
title.Text="Pet Align Program v46"
...
if okMath then
	statusText("v46: окно не двигается от ALIGN/BUG, действия идут по пету.")
else
