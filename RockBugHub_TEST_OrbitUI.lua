...
function HUD.mount(runtime, options)
    ...
    -- Bottom controls, but lifted above the Roblox hotbar.
    -- Keep both centered horizontally so they are still in the bottom zone.
    self.menu = create("TextButton", {Name="OpenFullMenu", AnchorPoint=Vector2.new(0.5,1), Position=UDim2.new(0.5,-58,1,-112), Size=UDim2.fromOffset(108,36), BackgroundColor3=background, BackgroundTransparency=0.08, TextColor3=white, TextSize=12, Font=Enum.Font.GothamBold, Text=tr("НАСТРОЙКИ","SETTINGS"), AutoButtonColor=true},self.overlay)
    round(self.menu,14); edge(self.menu,0.5)
    self.handle = create("TextButton", {Name="ToggleHologram", AnchorPoint=Vector2.new(0.5,1), Position=UDim2.new(0.5,58,1,-112), Size=UDim2.fromOffset(108,36), BackgroundColor3=background, BackgroundTransparency=0.08, TextColor3=cyan, TextSize=12, Font=Enum.Font.GothamBold, Text="", AutoButtonColor=true}, self.overlay)
