-- PetAlignHub v48_NEON_PROGRAM_UI
...
local function makeRockReport()
	...
	local lines={}
	table.insert(lines,"PetAlign v48 rock scan")
...
-- UI REBUILD v48 — neon program style
gui=Instance.new("ScreenGui")
gui.Name="PetAlignNeonV48"
gui.ResetOnSpawn=false
gui.DisplayOrder=999999
gui.IgnoreGuiInset=true
...
local function stroke(obj,col,thick,trans)
	...
	s.Color=col or Color3.fromRGB(140,72,255)
...
local function label(parent,text,x,y,w,h,size,color,bold)
	...
	l.Text=text
	l.TextColor3=color or Color3.fromRGB(235,230,255)
...
frame.Name="Main"
frame.Size=UDim2.new(0,430,0,545)
...
corner(frame,18)
stroke(frame,Color3.fromRGB(146,72,255),2,.05)
grad(frame,Color3.fromRGB(12,10,29),Color3.fromRGB(5,7,16),90)

local mini=Instance.new("TextButton",gui)
mini.Name="OpenMini"
mini.Size=UDim2.new(0,74,0,38)
mini.Position=UDim2.new(0,8,0,82)
mini.BackgroundColor3=Color3.fromRGB(74,34,170)
mini.Text="PET"
...
mini.Visible=false
corner(mini,12)
stroke(mini,Color3.fromRGB(162,82,255),1)

local top=Instance.new("Frame",frame)
top.Size=UDim2.new(1,0,0,48)
top.Position=UDim2.new(0,0,0,0)
top.BackgroundColor3=Color3.fromRGB(13,12,32)
top.BorderSizePixel=0
top.ZIndex=2
corner(top,18)

label(top,"✦",16,0,28,48,24,Color3.fromRGB(168,86,255),true)
label(top,"Pet Align Hub",48,0,178,48,18,Color3.fromRGB(255,255,255),true)

local ver=Instance.new("TextLabel",top)
ver.Size=UDim2.new(0,56,0,24)
ver.Position=UDim2.new(0,205,0,12)
ver.BackgroundColor3=Color3.fromRGB(34,22,72)
ver.Text="v4.8"
ver.TextColor3=Color3.fromRGB(196,144,255)
ver.Font=Enum.Font.GothamBlack
ver.TextSize=11
corner(ver,12)
stroke(ver,Color3.fromRGB(146,72,255),1,.1)

local minBtn=Instance.new("TextButton",top)
minBtn.Size=UDim2.new(0,32,0,30)
minBtn.Position=UDim2.new(1,-76,0,9)
minBtn.Text="−"
minBtn.TextColor3=Color3.new(1,1,1)
minBtn.BackgroundColor3=Color3.fromRGB(44,36,82)
...
close.Text="×"
close.TextColor3=Color3.fromRGB(255,190,205)
close.BackgroundColor3=Color3.fromRGB(74,24,42)
close.Font=Enum.Font.GothamBlack
close.TextSize=18
corner(close,9)

local inputCard=Instance.new("Frame",frame)
inputCard.Size=UDim2.new(1,-24,0,76)
inputCard.Position=UDim2.new(0,12,0,58)
inputCard.BackgroundColor3=Color3.fromRGB(14,14,31)
inputCard.BorderSizePixel=0
corner(inputCard,14)
stroke(inputCard,Color3.fromRGB(56,48,100),1,.2)

label(inputCard,"Перерождения",14,4,140,20,10,Color3.fromRGB(180,176,210),false)
rebBox=Instance.new("TextBox",inputCard)
rebBox.Size=UDim2.new(0,186,0,34)
rebBox.Position=UDim2.new(0,14,0,30)
rebBox.Text=""
rebBox.PlaceholderText="63.4k"
rebBox.ClearTextOnFocus=false
rebBox.TextColor3=Color3.new(1,1,1)
rebBox.PlaceholderColor3=Color3.fromRGB(140,135,170)
rebBox.BackgroundColor3=Color3.fromRGB(27,24,55)
rebBox.Font=Enum.Font.GothamBlack
rebBox.TextSize=14
corner(rebBox,10)
stroke(rebBox,Color3.fromRGB(74,61,130),1,.35)

label(inputCard,"Редкость питомца",218,4,150,20,10,Color3.fromRGB(180,176,210),false)
rarityBtn=Instance.new("TextButton",inputCard)
rarityBtn.Size=UDim2.new(0,174,0,34)
rarityBtn.Position=UDim2.new(0,218,0,30)
rarityBtn.Text="Auto"
rarityBtn.TextColor3=Color3.new(1,1,1)
rarityBtn.BackgroundColor3=Color3.fromRGB(59,48,116)
rarityBtn.Font=Enum.Font.GothamBlack
rarityBtn.TextSize=12
corner(rarityBtn,10)
grad(rarityBtn,Color3.fromRGB(54,46,115),Color3.fromRGB(100,62,200),0)

local tabRow=Instance.new("Frame",frame)
tabRow.Size=UDim2.new(1,-24,0,38)
tabRow.Position=UDim2.new(0,12,0,142)
tabRow.BackgroundColor3=Color3.fromRGB(14,14,31)
tabRow.BorderSizePixel=0
corner(tabRow,14)
stroke(tabRow,Color3.fromRGB(58,50,105),1,.25)

local function tab(txt,x,w,col)
...
local tabAlign=tab("⚙ ALIGN",4,96,Color3.fromRGB(91,45,198))
local tabBug=tab("⚑ BUG",106,88,Color3.fromRGB(23,23,47))
local tabScan=tab("⌕ SCAN",200,88,Color3.fromRGB(23,23,47))
local tabInfo=tab("☰ ALL",294,96,Color3.fromRGB(23,23,47))

local function card(parent,x,y,w,h,titleText,color,accent)
	...
	f.BorderSizePixel=0
	corner(f,14)
	stroke(f,accent or Color3.fromRGB(78,67,132),1,.2)

	label(f,titleText,12,6,w-24,20,12,Color3.fromRGB(255,255,255),true)
	local body=Instance.new("TextLabel",f)
	body.Size=UDim2.new(1,-24,1,-34)
	body.Position=UDim2.new(0,12,0,30)
	body.BackgroundTransparency=1
	body.TextColor3=Color3.fromRGB(255,236,165)
...
local bestFrame,bestText=card(frame,12,190,198,104,"♛ Лучший / выбранный",Color3.fromRGB(23,18,45),Color3.fromRGB(180,65,255))
targetText=bestText
local petFrame,petText=card(frame,220,190,198,104,"✦ Текущий пет",Color3.fromRGB(17,20,44),Color3.fromRGB(73,70,135))
currentText=petText
local alignFrame,alignText=card(frame,12,302,198,76,"⚙ Выравнивание",Color3.fromRGB(18,32,48),Color3.fromRGB(73,120,200))
planTextUi=alignText
local bugFrame,bugTextBody=card(frame,220,302,198,76,"⚑ Баг",Color3.fromRGB(50,20,34),Color3.fromRGB(200,70,105))
bugText=bugTextBody

local resTitle=Instance.new("Frame",frame)
resTitle.Size=UDim2.new(1,-24,0,24)
resTitle.Position=UDim2.new(0,12,0,386)
resTitle.BackgroundTransparency=1
label(resTitle,"Результаты",0,0,130,22,13,Color3.fromRGB(230,226,255),true)
resultsLabel=label(resTitle,"0 вариантов",260,0,140,22,10,Color3.fromRGB(170,165,205),false)
resultsLabel.TextXAlignment=Enum.TextXAlignment.Right

resultsScroll=Instance.new("ScrollingFrame",frame)
resultsScroll.Size=UDim2.new(1,-24,0,80)
resultsScroll.Position=UDim2.new(0,12,0,412)
resultsScroll.BackgroundColor3=Color3.fromRGB(13,14,28)
resultsScroll.BorderSizePixel=0
resultsScroll.ScrollBarThickness=5
resultsScroll.ScrollingDirection=Enum.ScrollingDirection.X
resultsScroll.CanvasSize=UDim2.new(0,0,0,0)
corner(resultsScroll,12)
stroke(resultsScroll,Color3.fromRGB(83,58,140),1,.15)
...
local list=Instance.new("UIListLayout",resultsScroll)
...
status.Position=UDim2.new(0,12,0,496)
...
local function bottomBtn(txt,x,w,color1,color2)
	...
	b.TextSize=11
	corner(b,10)
	stroke(b,color2 or Color3.fromRGB(255,255,255),1,.35)
	grad(b,color1,color2 or color1,0)
	return b
end

local alignBtn=bottomBtn("⚙ ALIGN",12,78,Color3.fromRGB(88,43,202),Color3.fromRGB(151,67,255))
local bugBtn=bottomBtn("⚑ BUG",98,68,Color3.fromRGB(28,150,76),Color3.fromRGB(59,220,110))
local scanBtn=bottomBtn("⌕ SCAN",174,72,Color3.fromRGB(26,116,205),Color3.fromRGB(65,158,255))
local copyBtn=bottomBtn("COPY",254,72,Color3.fromRGB(185,112,15),Color3.fromRGB(245,164,35))
local stopBtn=bottomBtn("STOP",334,78,Color3.fromRGB(160,35,54),Color3.fromRGB(255,76,92))
...
function render()
	...
	if err then
		targetText.Text=err
		currentText.Text="Открой окно питомца с XP."
		planTextUi.Text="-"
		bugText.Text="-"
		lastReport=err
	else
		...
		if diff then
			if diff<0 then
				planTextUi.Text="Выбранный вариант ниже текущего XP.\nВыбери другую карточку."
			else
				planTextUi.Text="Дорожки: "..planToString(plan).."\nАвтостоп после 5 стабильных чтений."
			end
		else
			planTextUi.Text="Жду чтение XP."
		end
	...
	for i=1,count do
		local row=rows[i]
		local cardBtn=choiceCards[i]
		if not cardBtn then
			local idx=i
			cardBtn=Instance.new("TextButton",resultsScroll)
			cardBtn.Name="ChoiceCard"..idx
			cardBtn.Size=UDim2.new(0,132,0,66)
			cardBtn.BackgroundColor3=Color3.fromRGB(20,20,42)
			cardBtn.BorderSizePixel=0
			cardBtn.AutoButtonColor=false
			cardBtn.Font=Enum.Font.GothamBlack
			cardBtn.TextSize=9
			cardBtn.TextWrapped=true
			cardBtn.TextXAlignment=Enum.TextXAlignment.Left
			cardBtn.TextYAlignment=Enum.TextYAlignment.Center
			cardBtn.TextColor3=Color3.fromRGB(255,238,170)
			cardBtn.LayoutOrder=idx
			corner(cardBtn,12)
			stroke(cardBtn,Color3.fromRGB(85,65,150),1,.15)
			cardBtn.MouseButton1Click:Connect(function()
				selectedCard=idx
				render()
				statusText("Выбрана карточка #"..idx)
			end)
			choiceCards[idx]=cardBtn
		end

		cardBtn.Visible=true
		cardBtn.LayoutOrder=i
		cardBtn.Text=("#%d %s\n%s\n%s lvl %s XP  +%s"):format(
			i,row.rarity,row.rockLabel,fmt(row.setLvl),fmt(row.setXp),fmt(row.bonus)
		)

		if i==selectedCard then
			cardBtn.BackgroundColor3=Color3.fromRGB(73,38,152)
		else
			cardBtn.BackgroundColor3=Color3.fromRGB(20,20,42)
		end
	end
	...
	if resultsScroll then
		resultsScroll.CanvasSize=UDim2.new(0,count*140+10,0,0)
	end
end
...
local function fitToScreen()
	...
	local scale=math.min(1,(vp.X-16)/430,(vp.Y-70)/545)
	if scale<.64 then scale=.64 end

	frame.Size=UDim2.new(0,430*scale,0,545*scale)
	local x=8
	local y=math.max(45,math.floor(vp.Y*.10))
...
statusText("v48: дизайн как хаб в проге. Перетаскивание за верх.")
render()
